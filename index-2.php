...
<html lang="en">
    ...
    <body >
        ...
        <section class="service-section fix section-bg section-padding pt-0">
            ...
            <div class="container">
                <div class="section-title-area">
                    ...
                    <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                        <a href="service.php"> <span class="theme-btn">EXPLORE MORE </span><span class="arrow-btn"><i class="fa-regular fa-arrow-up-right"></i></span></a>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="case-studies-section-2 fix section-padding bg-cover" style="background-image: url('assets/img/case-studies/bg.jpg');">
            <div class="container">
                <div class="section-title-area">
                    <div class="section-title">
                        <div class="sub-title bg-color-3 wow fadeInUp">
                ...
                <div class="case-studies-wrapper-2">
                    <div class="case-studies-items bor-top bor-bottom">
                        ...
                        <div class="main-button">
                            <a href="project-details.php"> <span class="theme-btn">Get Started </span><span class="arrow-btn"><i class="fa-regular fa-arrow-up-right"></i></span></a>
                        </div>
                    ...
                    <div class="case-studies-items bor-bottom">
                        <div class="content">
                            <h3><a href="project-details.php">Content Marketing</a></h3>
                            <span>MARKETING</span>
                            <p>
                                There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humor.
                            </p>
