...
<html lang="en">
    ...
    <body >
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-card-items style-2">
                            ...
                            <div class="content">
                                <h3 class="title-2">
                                    <a href="service-details.php">SEO Marketing</a>
                                </h3>
                                <p>
                                    Collaboratively formulate principle capital doing progressively evolve user
                                </p>
                                <a href="service-details.php" class="service-btn">Read more <i class="fa-solid fa-chevrons-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-card-items style-2">
                            ...
                            <div class="content">
                                <h3 class="title-2">
                                    <a href="service-details.php">Social Media Marketing</a>
                                </h3>
                                <p>
                                    Collaboratively formulate principle capital doing progressively evolve user
                                </p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="service-card-items style-2">
                            ...
                            <div class="content">
                                <h3 class="title-2">
                                    <a href="service-details.php">Email Marketing</a>
                                </h3>
                                <p>
                                    Collaboratively formulate principle capital doing progressively evolve user
                                </p>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="team-image-2">
                                <img src="assets/img/team/02.png" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
        ...
        <div class="marquee-section-1 marquee-2">
            <div class="mycustom-marque style-2 bg-2">
                <div class="scrolling-wrap">
                    <div class="comm">
                        <div class="cmn-textslide"><img src="assets/img/star-2.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="assets/img/star-2.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="assets/img/star-2.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="assets/img/star-2.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="assets/img/star-2.png" alt="img">THE BEST SOULTION</div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="case-studies-card-items">
                                ...
                                <div class="content">
                                    <div class="title">
                                        <h3><a href="project-details.php">PPC Advertising</a></h3>
                                        <p>Seo Design</p>
                                    </div>
                                    <a href="project-details.php" class="icon"><i class="fa-regular fa-arrow-up-right"></i></a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="case-studies-card-items">
                                ...
                                <div class="content">
                                    <div class="title">
                                        <h3><a href="project-details.php">Construction Planning</a></h3>
                                        <p>Designer</p>
                                    </div>
                                    <a href="project-details.php" class="icon"><i class="fa-regular fa-arrow-up-right"></i></a>
                                </div>
        ...
        <!-- About Section Start -->
        <section class="about-section-2 fix section-padding bg-cover" id="about" style="background-image: url('assets/img/team/team-bg.jpg');">
            <div class="bg-shape">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="about-image-2 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                               <img src="assets/img/choose-us.png" alt="img" class="w-100">
                            </div>
                        </div>
                        <div class="col-lg-6">
        ...
        <section class="cta-counter-section-2 section-padding bg-cover" style="background-image: url('assets/img/cta-counter-bg.jpg');">
            <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="news-card-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">About Personal Finance You Need to Stop Believing</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="news-card-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Ways to Unnecessary Expenses and Save Money</a></h5>
                                <a href="news-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                                <div class="post-date">
                                    <i class="fa-light fa-calendar-days"></i>
                                    Oct  05, 2024
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div class="news-card-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Budgeting Hacks for a Stress-Free Financial Life</a></h5>
                                <a href="news-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                                <div class="post-date">
                                    <i class="fa-light fa-calendar-days"></i>
                                    Oct  05, 2024
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div class="news-card-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Things You Must Quit Believing About Finances</a></h5>
                                <a href="news-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                                <div class="post-date">
                                    <i class="fa-light fa-calendar-days"></i>
                                    Oct  05, 2024
