...
<html lang="en">
    ...
    <body >
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-box-items">
                            ...
                            <div class="content"> 
                                <h4><a href="service-details.php">Digital Marketing</a></h4>
                                <p>Lorem dolor amet consectetur read adipiscing any more elit.</p>
                                <a href="service-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-box-items">
                            ...
                            <div class="content"> 
                                <h4><a href="service-details.php">SEO Analytics</a></h4>
                                <p>Lorem dolor amet consectetur read adipiscing any more elit.</p>
                                <a href="service-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="service-box-items">
                            ...
                            <div class="content"> 
                                <h4><a href="service-details.php">Social Marketing</a></h4>
                                <p>Lorem dolor amet consectetur read adipiscing any more elit.</p>
                                <a href="service-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
        ...
        <!-- About Section Start -->
        <section class="about-section fix section-padding" style="background-image: url('assets/img/about/about-bg.png');" id="about">
            <div class="left-shape float-bob-y">
                        ...
                        <div class="col-lg-6">
                            <div class="about-content">
                                ...
                                <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                                    <a href="about.php"> <span class="theme-btn"> EXPLORE MORE </span><span class="arrow-btn"><i class="fa-regular fa-arrow-up-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="case-study-box-items">
                                <div class="thumb">
                                    ...
                                    <div class="post-box-items">
                                        <ul>
                                            <li>
                                                <a href="project-details.php">Real-time Analytics <i class="fa-regular fa-arrow-up-right"></i></a>
                                            </li>
                                            <li>
                                                <a href="project-details.php">Social <i class="fa-regular fa-arrow-up-right"></i></a>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <a href="project-details.php">Agile Advance <i class="fa-regular fa-arrow-up-right"></i></a>
                                            </li>
                                            <li>
                                                <a href="project-details.php">Advance <i class="fa-regular fa-arrow-up-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="main-box">
                                <div class="box wow fadeInUp">
                                    <div class="title-items">
                                        <h3><a href="project-details.php">Digital Marketing</a></h3>
                                    ...
                                    <div class="project-content">
                                        ...
                                        <a href="project-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                                </div>
                                <div class="box bg-1 wow fadeInUp wow" data-wow-delay=".2s">
                                    <div class="title-items">
                                        <h3><a href="project-details.php">Instantly Analyze</a></h3>
                                ...
                                <div class="box bg-2 active wow fadeInUp wow" data-wow-delay=".4s">
                                    <div class="title-items">
                                        <h3><a href="project-details.php">Web & Mobile</a></h3>
                                ...
                                <div class="box bg-3 wow fadeInUp wow" data-wow-delay=".6s">
                                    <div class="title-items">
                                        <h3><a href="project-details.php">Email marketing</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Importers achieve savings through the First Sale rule!</a></h5>
                                <div class="news-btn">
                                    <a href="news-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Is now the right time to invest in an enterprise</a></h5>
                                <div class="news-btn">
                                    <a href="news-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                                    <img src="assets/img/news/client-img.png" alt="img">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Focus logistics secure new 
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            ...
                            <div class="news-content">
                                ...
                                <h5><a href="news-details.php">Transid Named a Finalist For Year’ 25 Best Choice </a></h5>
                                <div class="news-btn">
                                    <a href="news-details.php" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                                    <img src="assets/img/news/client-img.png" alt="img">
                                </div>
